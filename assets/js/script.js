 ...
 * in returned celculateCorrectAnswer array
 */
function checkAnswer() {
    ...
    if (isCorrect) {
        ...
        alert(`Ahh... you answered ${userAnswer}. The correct answer is ${calculatedAnswer[0]}`)
...
/**
 * Gets the operands (num's) and the operator (+/-...)
